...
const HelpCenter = ({ variant = "profile", className }: HelpCenterProps) => {
  ...
  const triggerClass =
    variant === "floating"
      ? "w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-primary to-secondary text-primary-foreground border border-primary/40 shadow-lg shadow-primary/30 ring-2 ring-primary/25 hover:scale-105 transition-all duration-200 flex items-center justify-center"
      : variant === "navbar"
